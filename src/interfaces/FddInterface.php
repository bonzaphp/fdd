...
Interface FddInterface
{
    ...
    public function viewTemplate($template_id);/*查看合同模版*/
    ...
    public function viewContract($contract_id):array;/**此接口将打开页面 合同查看*/
    public function downLoadContract($contract_id):array;/*合同下载*/
